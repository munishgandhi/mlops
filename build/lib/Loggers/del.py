...
class Hyly_Shim(object):
    ...
    def update_model_name(self, old_model_name, token_limit, new_model_name, user_prompt=""):
        if user_prompt != "":
            print("inside user_prompt!=")
            encoding = tiktoken.get_encoding("cl100k_base")
            print("encoding: ", encoding)
            print("encoding.encode(user_prompt): ", encoding.encode(user_prompt))
            print("len(encoding.encode(user_prompt)): ", len(encoding.encode(user_prompt)))
            total_token_len = len(encoding.encode(user_prompt)) + 512
            print("total_token_len: ", total_token_len, "token_limit: ", token_limit)
